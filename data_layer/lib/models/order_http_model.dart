...
class OrderHttpModel{
  ...
  double? summa;
  String? comment;  
  OrderHttpModel({required this.type_order, required this.phone, required this.items, 
  required this.adress, required this.comment, required this.summa, required this.type_payment});
